...
def draw_handler(canvas):
    ...
    for barrier in globals.barriers:
        barrier.draw(canvas)
    canvas.draw_text(str(globals.picker.score), [globals.grid_size * (globals.board_size[0]-3), globals.grid_size * (globals.board_size[1]-2)], 30, 'blue')
...
def poll_keyboard():
    #TODO: Make this respect the second player (picker)
